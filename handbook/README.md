...
| ------- | ---- | --------- |
| **Print edition (current, bound)** | `site/static/handbook/Council_Handbook.pdf` | `/handbook/Council_Handbook.pdf` |
...
`site/static/handbook/Council_Handbook.pdf` (or add the new file
